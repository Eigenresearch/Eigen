...
def main():
    ...
    run_parser.add_argument("-O", type=int, choices=[0, 1, 2, 3], help="Set compiler optimization level (0-3)")
    ...
    build_parser.add_argument("--qasm", action="store_true", help="Export to OpenQASM 3.0 format")
    build_parser.add_argument("--quil", action="store_true", help="Export to Quil format")
    ...
    viz_parser = subparsers.add_parser("viz", help="Generate SVG visualization of an Eigen quantum circuit")
    viz_parser.add_argument("file", help="Path to the source file")
    viz_parser.add_argument("-o", "--output", help="Path to the output SVG file")
